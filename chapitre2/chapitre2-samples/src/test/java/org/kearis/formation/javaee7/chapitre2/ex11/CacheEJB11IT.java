...
public class CacheEJB11IT extends AbstractEJBTest {
  ...
  public void shouldAddRemoveAndGetThingsFromTheCache() throws Exception {
    ...
    Object ejb = ctx.lookup("java:global/chapitre2-samples-1.0.0-SNAPSHOT/CacheEJB11");
    assertNotNull(ejb);

    // Looks up the EJB
    CacheEJBRemote11 cacheEJB = (CacheEJBRemote11) PortableRemoteObject.narrow(ejb, CacheEJBRemote11.class);
