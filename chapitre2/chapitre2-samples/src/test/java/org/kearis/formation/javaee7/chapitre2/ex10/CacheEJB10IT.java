...
public class CacheEJB10IT extends AbstractEJBTest {
  ...
  public void shouldAddRemoveAndGetThingsFromTheCache() throws Exception {
    ...
    Object ejb = ctx.lookup("java:global/chapitre2-samples-1.0.0-SNAPSHOT/CacheEJB10");
    assertNotNull(ejb);

    // Looks up the EJB
    CacheEJBRemote10 cacheEJB = (CacheEJBRemote10) PortableRemoteObject.narrow(ejb, CacheEJBRemote10.class);
